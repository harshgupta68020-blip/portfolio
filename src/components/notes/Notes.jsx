    ...
    <section id="notes" className="py-32 md:py-40 px-4 max-w-[1400px] mx-auto">
      ...
      <div className="text-center mb-16 md:mb-24">
        <ScrubbedWordReveal
          ...
          className="text-white font-semibold text-[clamp(1.75rem,3.5vw,3.5rem)] tracking-[-0.02em] max-w-[900px] mx-auto leading-tight"
        />
      </div>

      {/* Typography-first Masonry Grid with M6 Spotlight Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {notesData.map((note, idx) => (
          <SpotlightCard
            key={idx}
            className={`bg-white/[0.03] border border-white/10 hover:border-white/20 rounded-[24px] backdrop-blur-sm transition-all duration-300 shadow-lg ${
