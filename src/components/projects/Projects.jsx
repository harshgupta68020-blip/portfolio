...
import { SpotlightCard } from '@/components/motion/MicroInteractions';
  ...
  return (
    <section id="projects" className="py-32 md:py-40 px-4 max-w-[1400px] mx-auto">
      ...
      <div className="text-center mb-16 md:mb-24">
        <LineMaskHeading
          as="h2"
          lines={['Featured Engineering Work']}
          scrollTrigger={true}
      ...
      <div className="flex flex-col gap-12 md:gap-16">
        {/* Featured Project Card with Spotlight (IntelliLight) */}
        {featuredProject && (
          <SpotlightCard className="bg-white/[0.03] border border-white/10 hover:border-white/20 rounded-[24px] transition-all duration-300 backdrop-blur-sm min-h-[600px] shadow-2xl">
            <motion.div
              {...cardHoverProps}
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-8 pt-6 border-t border-white/10">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-white text-[#09090B] font-medium text-sm px-6 py-2.5 rounded-full hover:bg-white/90 transition-all shadow-md"
                >
        ...
        {/* Grid for Secondary Projects & Future Exploration with Spotlight */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {secondaryProjects.map((project) => (
            <SpotlightCard
              key={project.id}
              className={`bg-white/[0.03] border border-white/10 hover:border-white/20 rounded-[24px] transition-all duration-300 backdrop-blur-sm ${
